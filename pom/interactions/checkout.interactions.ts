...
export class CheckoutInteractions {
   ...
   async assertTotalIsCorrect(price: number) {
    ...
    /**
     * Asserts the continue button is disabled
     */
    async assertContinueDisabled() {
        await expect(this.checkoutPage.continueButton).toBeDisabled();
    }
    ...
    async assertSuccessMessage() {
        await expect(this.checkoutPage.message).toBeVisible();
        await expect(this.checkoutPage.message).toHaveText("Thank you for your order!");
    }
    ...
    async assertFailureMessage() {
        await expect(this.checkoutPage.message).toBeVisible();
        await expect(this.checkoutPage.message).toHaveText("There was a problem with your order");
    }
